...
<figure>
<img alt="LKC의 v0.1.2 화면" src="./project__lkc_screenshot_0.1.2.jpg" />
<figcaption>LKC의 v0.1.2 화면</figcaption>
</figure>
...
| 8. 사용성 개선 및 배포/접속/운영 안정성 (~) | 8-1. 실제 사용 후 사용성 개선 | 코/단 최대값, 이동 툴 사용 가능 범위 등 정책 수정 반영 |
|   | 8-2. 이슈 처리, 테스트 단계 자동화 시도 (△) |   |
